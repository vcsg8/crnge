...
local Menu_Spawn_Master = missionCommands.addSubMenu('Unit Spawning')
  ...
  local Menu_AA_Drones = missionCommands.addSubMenu('Air to Air Drones',Menu_Spawn_Master)
    ...
    local Menu_BVR_Drones = missionCommands.addSubMenu('BVR Drone Range', Menu_AA_Drones)

      local Menu_BVR_Single = missionCommands.addSubMenu('COMBAT - Single Drones', Menu_BVR_Drones)  
      ...
      local Menu_BVR_Double = missionCommands.addSubMenu('COMBAT - Double Drones', Menu_BVR_Drones)  
       ...
       local Menu_BVR_Neutral = missionCommands.addSubMenu('NON COMBAT DRONES', Menu_ACM_Drones) 
        local selection_bvr_dr_Hawkx1 = missionCommands.addCommand('Single Hawk Target Drone', Menu_BVR_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single Hawk Target Drone", qty = 1, loc = "N_A2A_BVR_Drone_SGL", dir = 270})
        local selection_bvr_dr_Hawkx2 = missionCommands.addCommand('Two-Ship Hawk Target Drone', Menu_BVR_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship Hawk Target Drone", qty = 1, loc = "N_A2A_BVR_Drone_DBL", dir = 270})  
        local selection_bvr_dr_Phantomx1 = missionCommands.addCommand('Single Phantom Target Drone', Menu_BVR_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single Phantom Target Drone", qty = 1, loc = "N_A2A_BVR_Drone_SGL", dir = 270})
        local selection_bvr_dr_Phantomx2 = missionCommands.addCommand('Two-Ship Phantom Target Drone', Menu_BVR_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship Phantom Target Drone", qty = 1, loc = "N_A2A_BVR_Drone_DBL", dir = 270})  
        local selection_bvr_dr_H6x1 = missionCommands.addCommand('Single C-17 Target Drone', Menu_BVR_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single C-17 Target Drone", qty = 1, loc = "N_A2A_BVR_Drone_SGL", dir = 270})    
        local selection_bvr_dr_H6x2 = missionCommands.addCommand('Two-Ship C-17 Target Drone', Menu_BVR_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship C-17 Target Drone", qty = 2, loc = "N_A2A_BVR_Drone_DBL", dir = 270}) 
        

    local Menu_ACM_Drones = missionCommands.addSubMenu('ACM Drone Range', Menu_AA_Drones)

      local Menu_ACM_Single = missionCommands.addSubMenu('COMBAT - Single Drones', Menu_ACM_Drones)  
      ...
      local Menu_ACM_Double = missionCommands.addSubMenu('COMBAT - Double Drones', Menu_ACM_Drones)  
      ...
      local Menu_ACM_Neutral = missionCommands.addSubMenu('NON COMBAT DRONES', Menu_ACM_Drones) 
        local selection_acm_dr_Hawkx1 = missionCommands.addCommand('Single Hawk Target Drone', Menu_ACM_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single Hawk Target Drone", qty = 1, loc = "N_A2A_ACM_Drone_SGL", dir = 318})
        local selection_acm_dr_Hawkx2 = missionCommands.addCommand('Two-Ship Hawk Target Drone', Menu_ACM_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship Hawk Target Drone", qty = 1, loc = "N_A2A_ACM_Drone_DBL", dir = 318})  
        local selection_acm_dr_Phantomx1 = missionCommands.addCommand('Single Phantom Target Drone', Menu_ACM_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single Phantom Target Drone", qty = 1, loc = "N_A2A_ACM_Drone_SGL", dir = 318})
        local selection_acm_dr_Phantomx2 = missionCommands.addCommand('Two-Ship Phantom Target Drone', Menu_ACM_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship Phantom Target Drone", qty = 1, loc = "N_A2A_ACM_Drone_DBL", dir = 318})  
        local selection_acm_dr_H6x1 = missionCommands.addCommand('Single C-17 Target Drone', Menu_ACM_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single C-17 Target Drone", qty = 1, loc = "N_A2A_ACM_Drone_SGL", dir = 318})    
        local selection_acm_dr_H6x2 = missionCommands.addCommand('Two-Ship C-17 Target Drone', Menu_ACM_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship C-17 Target Drone", qty = 2, loc = "N_A2A_ACM_Drone_DBL", dir = 318})
        
    local Menu_WW2_Drones = missionCommands.addSubMenu('WW2 Drones (in ACM Range)', Menu_AA_Drones)

      local Menu_WW2_Single = missionCommands.addSubMenu('COMBAT - Single Drones', Menu_WW2_Drones)  
      ...
      local Menu_WW2_Double = missionCommands.addSubMenu('COMBAT - Double Drones', Menu_WW2_Drones)  
      ...
      local Menu_WW2_Neutral = missionCommands.addSubMenu('NON COMBAT DRONES', Menu_WW2_Drones)
        local selection_dr_I16_x1 = missionCommands.addCommand('Single I-16 Target Drone', Menu_WW2_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single I-16 Target Drone", qty = 1, loc = "N_A2A_WW2_Drone_SGL", dir = 318})
        local selection_dr_I16Nx2 = missionCommands.addCommand('Two-Ship I-16 Target Drone', Menu_WW2_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship I-16 Target Drone", qty = 2, loc = "N_A2A_WW2_Drone_DBL", dir = 318}) 
        local selection_dr_A20x1 = missionCommands.addCommand('Single A-20 Target Drone', Menu_WW2_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single A-20 Target Drone", qty = 1, loc = "N_A2A_WW2_Drone_SGL", dir = 318})
        local selection_dr_A20x2 = missionCommands.addCommand('Two-Ship A-20 Target Drone', Menu_WW2_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship A-20 Target Drone", qty = 2, loc = "N_A2A_WW2_Drone_DBL", dir = 318})
        local selection_dr_C130x1 = missionCommands.addCommand('Single C-130 Target Drone', Menu_WW2_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Single C-130 Target Drone", qty = 1, loc = "N_A2A_WW2_Drone_SGL", dir = 318})
        local selection_dr_C130x2 = missionCommands.addCommand('Two-Ship C-130 Target Drone', Menu_WW2_Neutral, CSG8F.crnge.spawn.spawnTargetDrones, {plane = "Two-Ship C-130 Target Drone", qty = 2, loc = "N_A2A_WW2_Drone_DBL", dir = 318})
